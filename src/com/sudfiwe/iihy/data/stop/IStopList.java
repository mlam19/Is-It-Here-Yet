...
public interface IStopList {
	...
	abstract StopDirection[] getDirections();
	abstract StopDirection getDirection(String dirTag);
	abstract Stop getItem(String dirTag,String stopTag);
	abstract Stop[] getList(String dirTag);	
}
